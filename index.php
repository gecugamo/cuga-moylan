...
<main>
	...
	<!-- Work -->
	<section id="work" class="layout-wrap">
	    <div class="layout">
	...
	<!-- About -->
	<section id="about" class="layout-wrap">
	    <div class="layout">
	        <div class="layout-content">
	            <h4 class="section-title">about</h4>
	            <div class="flex-row">
	                <div class="flex-item md-half layout-divider">
		...
		<div class="modal">
			...
			<div class="modal__body">
				<div class="project__info">
					...
					<p class="project__summary">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati, laborum aspernatur? Nihil dicta labore, voluptate cumque.</p>
					<a class="btn small" href="#0">Visit Site</a>
				</div>
				<div class="project__code_example">
